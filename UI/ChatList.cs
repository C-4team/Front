...
namespace UI
{
    public partial class ChatList : Form
    {
        ...
        private void Group1_Panel_Click(object sender, EventArgs e)
        {
            ...
            ChatRoom = new chattingRoom(MyName, Group1_ID, Group2_Info, Connection);
            ChatRoom.Show();
        }
        ...
        private void Group2_Panel_Click(object sender, EventArgs e)
        {
            ...
            ChatRoom = new chattingRoom(MyName, Group2_ID, Group2_Info , Connection);
            ChatRoom.Show();
        }
        ...
        private void Group3_Panel_Click(object sender, EventArgs e)
        {
            ...
            ChatRoom = new chattingRoom(MyName, Group3_ID, Group2_Info, Connection);
            ChatRoom.Show();
        }
    }
}
